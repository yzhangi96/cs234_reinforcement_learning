...
class PolicyGradient(object):
    ...
    def init_policy(self):
        """
        1. Creates a network using build_mlp.
        2. If self.discrete = True, instantiate a CategoricalPolicy.
           If self.discrete = False , instantiate a GaussianPolicy.
        3. Uses Adam optimizer for the policy, with learning rate self.lr
        """
    ...
    def get_returns(self, paths):
        ...
        for path in paths:
            ...
            for i in range(len(rewards) - 2, -1, -1):
                returns.insert(0, rewards[i] + self.config.gamma * returns[0])
